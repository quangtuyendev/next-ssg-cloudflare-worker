    ...
    return (
        <div className="col-md-4">
            <div className="card mb-4 box-shadow">
                <Link href="/articles/[slug]/[id]" as={`/articles/${title.replace(/[^\w\s]/gi, '').toLowerCase().split(' ').join('-')}/${id}`}>
                    <a>
                        <img title={title} className="card-img-top" src={image} alt={title} />
                    </a>
                </Link>
